           ...
           // Convert the percentage to a decimal
            ...
            do {
                ...
                for (month = 1; month <= 12; month++) {
                    ...
                    //subtract the payment from the balance before calculating in the interest 
                    ...
                    cout << setw(6) << month << setw(12) << "$ " << fixed << setprecision(2) << loanAmount
                        << setw(12) << "$ " << payment << setw(14) << "$ " << monthlyInterest
                        << setw(18) << "$ " << newBalance << endl;

                    // set loanAmount to newBalance for the next month
                ...
                cout << endl;
                cout << "Total Payments: $" << fixed << setprecision(2) << totalPayments << endl;
